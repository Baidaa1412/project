...
<body style="background-color:#BEBEBE">
                            ...
                            <div class="table-title">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6" style="">
                                        <a href="#deleteModal" class="btn " data-toggle="modal" style="background:rgb(138, 22, 22)"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>
                                        <a href="#addModal" class="btn " data-toggle="modal" style="background: #4e4032"><i class="material-icons" >&#xE147;</i> <span>Add New Category</span></a>
                                    </div>
                                </div>
                            </div>
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#editModal{{ $item->id }}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit" style="color: rgb(137, 116, 69)">&#xE254;</i></a>
                                            <a href="#deleteModal{{ $item->id }}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete" style="color: rgb(138, 22, 22)">&#xE872;</i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <!-- Placing the scripts at the end of the document -->
