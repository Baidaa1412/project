<nav class="navbar p-0 fixed-top d-flex flex-row"  style="background-color: #B3B0A9">
      ...
      <ul class="navbar-nav w-100">
        <li class="nav-item w-100">
          <form class="nav-link mt-2 mt-md-0 d-none  d-lg-flex search" action="{{url('search')}}" method="GET">
            <input type="text"  name="search" class="form-control" placeholder="Search products" value="{{Request::get('search')}}" style="background-color: white">
          </form>
        </li>
      </ul>
